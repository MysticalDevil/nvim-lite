...
local options = {
  ...
  cmdheight = 0, -- use the 0.12 message UI and keep the command line hidden until needed
...
vim.opt.formatoptions:remove({ "c", "o" }) -- keep Enter comment continuation ("r"), disable auto-wrap and `o/O` continuation
